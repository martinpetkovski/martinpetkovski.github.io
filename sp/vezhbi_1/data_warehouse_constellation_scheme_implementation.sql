CREATE DATABASE IF NOT EXISTS data_warehouse_constellation_scheme_implementation DEFAULT CHARACTER SET utf8;

USE data_warehouse_constellation_scheme_implementation;
...
CREATE TABLE IF NOT EXISTS FactImports
(
SalesPersonKey int NOT NULL,
ProductKey int NOT NULL,
ShippingAgentKey int NOT NULL,
...
FOREIGN KEY(ShippingAgentKey) REFERENCES DimShippingAgent(ShippingAgentKey),
FOREIGN KEY(TimeKey) REFERENCES DimDate(DateKey),
CONSTRAINT PK_FactImports PRIMARY KEY
(
	SalesPersonKey,ProductKey,ShippingAgentKey,TimeKey
));